...
namespace EasyWeb.Model.Models
{
    public partial class NguyenContext : DbContext
    {
        public NguyenContext()
        {
        }

        public NguyenContext(DbContextOptions<NguyenContext> options)
            : base(options)
        {
        }
